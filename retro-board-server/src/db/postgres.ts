...
export async function getDb(sync: boolean = false) {
...
const get = (store: Connection, sessionRepository: SessionRepository) => async (
  sessionId: string
) => {
  try {
...
const set = (store: Connection, sessionRepository: SessionRepository) => async (
  session: JsonSession
) => {
